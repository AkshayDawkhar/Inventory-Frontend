                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            image: NetworkImage('${HttpHelper.HOSTNAME}/static/${selected[index]['pid']}.png'), fit: BoxFit.fill)),
                                    child: Column(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                            ...
                                            borderRadius: BorderRadius.all(Radius.circular(12)),
                                            image: DecorationImage(
                                                image: NetworkImage('${HttpHelper.HOSTNAME}/static/${snapshot.data![index]['pid']}.png'),
                                                fit: BoxFit.fill)),
